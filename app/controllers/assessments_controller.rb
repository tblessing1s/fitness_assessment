...
private
	...
	def assessment_params
		...
		permit(:client_id,
			...
			core_attributes: [:assessment_id, :trunk_lateral_flexion_left, :trunk_lateral_flexion_right, :trunk_rotation_left, :trunk_rotation_right, :trunk_flexion, :trunk_extension]
			)
	end
end
