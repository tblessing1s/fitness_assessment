class Hip < ApplicationRecord
  ...
  validates :hip_flexion_right, :hip_flexion_left, :hip_extension_left, :hip_extension_right, 
  			...
  			:hip_internal_rotation_0_left, :hip_internal_rotation_0_right, :hip_external_rotation_0_left, :hip_external_rotation_0_right, 
  			presence: true

  	def overall_average
  		(hip_flexion_right + hip_flexion_left + hip_extension_left + hip_extension_right + hip_abduction_left + hip_abduction_right + hip_adduction_left + hip_adduction_right + hip_internal_rotation_90_left + hip_internal_rotation_90_right + hip_external_rotation_90_left + hip_external_rotation_90_right + hip_internal_rotation_0_left + hip_internal_rotation_0_right + hip_external_rotation_0_left + hip_external_rotation_0_right)/16
  	end
	...
	def internal_external_rotation_0_difference_left
		JointBalanceService.calculate_differences(hip_internal_rotation_0_left, hip_external_rotation_0_left)
  	end

	def internal_external_rotation_0_difference_right
		JointBalanceService.calculate_differences(hip_internal_rotation_0_right, hip_external_rotation_0_right)
	end

	def internal_rotation_0_difference
		JointBalanceService.calculate_differences(hip_internal_rotation_0_left, hip_internal_rotation_0_right)
	end

	def external_rotation_0_difference
		JointBalanceService.calculate_differences(hip_external_rotation_0_left, hip_external_rotation_90_right)
	end
	...
	def percent_deviation_hip_internal_rotation_0_left
    	JointBalanceService.joint_deviation_difference(hip_internal_rotation_0_left, overall_average)
 	end
 	
	def percent_deviation_hip_internal_rotation_0_right
    	JointBalanceService.joint_deviation_difference(hip_internal_rotation_0_right, overall_average)
 	end
 	
	def percent_deviation_hip_external_rotation_0_left
    	JointBalanceService.joint_deviation_difference(hip_external_rotation_0_left, overall_average)
 	end
 	
	def percent_deviation_hip_external_rotation_0_right
    	JointBalanceService.joint_deviation_difference(hip_external_rotation_0_right, overall_average)
 	end
